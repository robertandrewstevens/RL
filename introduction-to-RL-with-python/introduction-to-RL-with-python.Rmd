...
![Markov decision process](introduction-to-reinforcement-learning-with-python-1.png){width=100%}
...
Return G_t is defined as the discounted sum of rewards from time step t.
...
![Bandit machine](introduction-to-reinforcement-learning-with-python-2.jpg){width=100%}
